...
[Dit concept heet polymorfisme en wordt later uitgelegd](https://timdams.gitbooks.io/csharpfromantwerp/content/15_polymorfisme/11_polymo_intro.html).
...
En als we polymorfisme gebruiken ([zie verder](https://timdams.gitbooks.io/csharpfromantwerp/content/15_polymorfisme/11_polymo_intro.html)) dan mag dit ook: `Dier paardje= new Paard();`
...
Maak de klassen van het volgende schema: ![Klassenschema enclave](https://timdams.gitbooks.io/csharpfromantwerp/content/assets/7_overerving/corklassen.png)
